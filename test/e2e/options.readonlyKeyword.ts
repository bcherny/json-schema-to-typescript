...
// With `readonlyKeyword`, JSON Schema's `readOnly: true` annotation (draft 7+, also OpenAPI) gives
// the property TypeScript's `readonly` modifier, and an annotated array or tuple becomes `readonly T[]`.
export const input = {
  title: 'ReadonlyKeyword',
  type: 'object',
  definitions: {
    tags: {
      title: 'Tags',

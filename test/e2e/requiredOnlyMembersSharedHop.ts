 ...
 * with two parents, parsed (and cached) once, so it cannot borrow `a`/`b` from either object: they
 * come out `unknown`, the same under both, whichever of them the linker reaches first --

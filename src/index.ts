...
export interface Options {
  /**
   * Generate an [index signature](https://www.typescriptlang.org/docs/handbook/2/objects.html#index-signatures) on objects when 'additionalProperties' is undefined or true. (Default true).
   */
  additionalPropertiesSignature: boolean
  /**
...
export const DEFAULT_OPTIONS: Options = {
  $refOptions: {},
  additionalPropertiesSignature: true,
